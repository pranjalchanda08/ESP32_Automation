...
typedef enum control_q_msg_id
{
    ...
    CONTROL_Q_MSG_ID_SET_CH0_SWITCH,          /**< Set channel switch state (Manual) */
    CONTROL_Q_MSG_ID_SET_CH1_SWITCH,          /**< Set channel switch state (Manual) */
    CONTROL_Q_MSG_ID_SET_CH2_SWITCH,          /**< Set channel switch state (Manual) */
    CONTROL_Q_MSG_ID_SET_CH3_SWITCH,          /**< Set channel switch state (Manual) */
    CONTROL_Q_MSG_ID_SET_MOTION_DETECTED,     /**< Set person detected state */
